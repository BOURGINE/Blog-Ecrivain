...
{ // Si pas de session demande l'inscription ou la connexion
    ...
    $info2='<a href="index.php?action=formInscription"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> INSCRIPTION </a>';
}
?>
...
<div id="page">
    ...
    ******************************** -->
    ...
    <p id="dernier-element"></p> <!-- Pour alignement CSS-->
<!-- ****************************************
		 FOOTER
********************************************* -->
    <footer id="footer">
...
<script src="public/javaScript/sliderTitre.js"></script>
